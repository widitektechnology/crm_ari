...
app = FastAPI(
    ...
    description="Sistema de gestión integral para ARI Family Assets",
    version="2.0.0",
    lifespan=lifespan,
...
# HTTP Basic authentication for documentation
security = HTTPBasic()
...
def get_current_docs_user(credentials: HTTPBasicCredentials = Depends(security)):
    ...
    correct_password = secrets.compare_digest(credentials.password, "crm2025@docs")
...
async def log_requests(request: Request, call_next):
    ...
    process_time = logging.time() - start_time
